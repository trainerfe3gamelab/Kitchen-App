...
const SideNav = ({ open, setOpen }) => {
    ...
    const handleMenuClick = (id, path) => {
        setActiveMenu(id);
        setOpen(false); // Tutup SideNav setelah menu diklik
        navigate(path);
    };
    ...
    return (
        <div className={`bg-Sidebar ${open ? 'w-72' : 'w-20'} duration-500 h-full relative`}>
            <img
                src="/src/assets/control.png" // Path dimulai dari root aplikasi
            ...
            <div className="m-3">
                <img
                    src="/src/assets/LOGO.png" // Path dimulai dari root aplikasi
                    alt=""
