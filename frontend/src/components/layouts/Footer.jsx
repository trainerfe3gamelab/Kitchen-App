                ...
                <div className="mt-5 px-3 justify-center flex w-full gap-5 lg:gap-10 lg:ml-10 lg:w-auto">
                    ...
                    <div className="text-sm">
                        ...
                        <div className="flex gap-3 mt-4">
                            <a href="#">
                                <svg role="img" className="w-4 h-4" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button className="rounded-full bg-white p-2 border border-black mt-4 text-sm">Support Palestine</button>
                    </div>
                </div>
            </div>
        </section>
